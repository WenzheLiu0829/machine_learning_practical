...
class ReciprocalLearningRateScheduler(ConstantLearningRateScheduler):
    ...
    def __init__(self, learning_rate, decay_rate):
        ...
        Args:
            learning_rate: Learning rate to use in learning rule.
        """
        super(ReciprocalLearningRateScheduler, self).__init__(learning_rate)
    ...
    def update_learning_rule(self, learning_rule, epoch_number):
        ...
        Args:
            ...
            epoch_number: Integer index of training epoch about to be run.
        """
        learning_rule.learning_rate = self.learning_rate / float(1 + epoch_number/self.decay_rate)
        
class MomentumLearningRateScheduler(ConstantLearningRateScheduler):
    
    def __init__(self, learning_rate, asymptotic_mom_coeff, Tau, Gamma):
        """Construct a new constant learning rate scheduler object.

        Args:
            learning_rate: Learning rate to use in learning rule.
        """
        super(MomentumLearningRateScheduler, self).__init__(learning_rate)
        self.mom_coeff = asymptotic_mom_coeff
        self.Tau = Tau
        self.Gamma = Gamma
    def update_learning_rule(self, learning_rule, epoch_number):
        """Update the hyperparameters of the learning rule.
        ...
        Args:
            ...
            epoch_number: Integer index of training epoch about to be run.
        """
        learning_rule.mom_coeff = self.mom_coeff - ((self.mom_coeff*self.Gamma) / float(epoch_number+self.Tau))
